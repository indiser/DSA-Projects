...
**A production-grade, high-performance distributed caching system inspired by Redis**  
*Built from scratch in modern C++ with LRU/LFU eviction policies, consistent hashing, and RESP protocol support*
...
**Mini-Redis** is a lightweight, high-performance distributed caching system built from the ground up in modern C++17. This project demonstrates advanced data structures, algorithms, and system design principles commonly used in production-grade distributed systems at companies like Amazon, Google, and Meta.
...
[⬆ Back to Top](#-mini-redis-distributed-cache-system)
